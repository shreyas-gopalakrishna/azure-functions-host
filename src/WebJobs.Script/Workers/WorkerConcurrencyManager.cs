...
namespace Microsoft.Azure.WebJobs.Script.Workers
{
    internal class WorkerConcurrencyManager : IHostedService, IDisposable
    {
        ...
        private readonly IScmHostingConfigurations _scmHostingConfigurations;
        ...
        public WorkerConcurrencyManager(
            ...
            IScmHostingConfigurations scmHostingConfigurations,
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            _scmHostingConfigurations = scmHostingConfigurations;
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
                ...
                || workerRuntime == RpcWorkerConstants.PythonLanguageWorkerName)
            {
                ...
                {
                    // The worker concurreny feature can be activated once ScmHostingConfigurations is updated
        ...
        private void OnActivationTimer(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                if (_timer == null && _scmHostingConfigurations.FunctionsWorkerDynamicConcurrencyEnabled)
                {
                ...
                else if (_timer != null && !_scmHostingConfigurations.FunctionsWorkerDynamicConcurrencyEnabled)
                {
                    // if the feature was activated by ScmHostingConfigurations and then disabled - shutdown the host
