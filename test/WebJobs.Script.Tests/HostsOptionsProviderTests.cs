...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class HostsOptionsProviderTests
    {
        ...
        public void Multiple_Extensions_Works_Success()
        {
            ...
            Assert.Equal(ReadFixture("TestMultipleBindings.json"), payload);
        }
        ...
        private string GetHostOptionProviderPayload<TExtension, TOptions>(Dictionary<string, string> settings) where TExtension : class, IExtensionConfigProvider where TOptions : class
        {
        ...
        private IHost SetupHostOptionProvider<TExtension, TOptions>(Dictionary<string, string> settings) where TExtension : class, IExtensionConfigProvider where TOptions : class
        {
